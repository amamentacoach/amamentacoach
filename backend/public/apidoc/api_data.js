define({ "api": [
  ...
  },
  {
    ...
    "description": "<p>Mae revoga consentimento e deve ser redirecionada para pagina de login</p>",
    "group": "Mães",
    "header": {
      "fields": {
        "Header": [
  ...
  },
  {
    ...
    "url": "/telemetria",
    "title": "Informar acao",
    "description": "<p>Informa as acoes da mae no App</p>",
    "group": "Telemetria",
    "header": {
      "fields": {
        "Header": [
  ...
  {
    "type": "put",
    "url": "/user/informarNascimento",
    "title": "Gestante->Informar nascimento",
    "group": "Usuário",
    "header": {
      "fields": {
        "Header": [
    ...
    "filename": "./src/routes.ts",
    "groupTitle": "Usuário",
    "name": "PutUserInformarnascimento"
  }
] });
